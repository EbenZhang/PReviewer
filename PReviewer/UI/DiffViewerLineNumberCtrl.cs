...
namespace PReviewer.UI
{
    class DiffViewerLineNumberCtrl : LineNumberMargin
    {
        ...
        private int MaxValueOfLineNum = 0;
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            _FormattedMaxLineNumber = new FormattedText(MaxValueOfLineNum.ToString(), 
        ...
        public void AddDiffLineNum(DiffLineNum diffLineNum)
        {
            ...
            MaxValueOfLineNum = Math.Max(diffLineNum.LeftLineNum, diffLineNum.RightLineNum);
        }
