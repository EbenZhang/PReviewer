...
namespace DiffMatchPatch {
  ...
  public class diff_match_patch {
    ...
    /// <summary>
    /// Added By Eben Zhang, to be documented.
    /// </summary>
    ...
    {
        var linesResult = diff_linesToChars(text1, text2);
        var lineText1 = linesResult[0];
        var lineText2 = linesResult[1];
        List<string> lineArray = linesResult[2] as List<string>;
        List<Diff> diffs = diff_main(lineText1.ToString(), lineText2.ToString(), false);
